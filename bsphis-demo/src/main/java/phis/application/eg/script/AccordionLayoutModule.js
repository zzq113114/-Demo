 ...
 */
phis.application.eg.script.AccordionLayoutModule = function(cfg) {

    phis.application.eg.script.AccordionLayoutModule.superclass.constructor.apply(this,
        [cfg])
}

Ext.extend(phis.application.eg.script.AccordionLayoutModule, phis.script.TableForm, {
    /*
     * 获取表单二的内容
     * 根据传入的父类对象获取form_2对象
     */
